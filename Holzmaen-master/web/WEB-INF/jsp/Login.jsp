...
<body>
<h1>Anmeldung:</h1>
<%  // Mit diesem Tag k�nnen wir Java Code in eine JSP Seite einbauen
// und DYNAMISCHE Seiteninhalte (die Fehlermeldung) erzeugen:
// Die Objekte "session", "request", "out" (dazu sp�ter mehr)
// sind IMMER bereits gesetzt und wir k�nnen sie direkt verwenden.
