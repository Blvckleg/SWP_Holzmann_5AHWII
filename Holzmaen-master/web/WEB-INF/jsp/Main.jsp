...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="left">
            ...
            <%
                // BEISPIEL für HTML Erzeugung in der JSP Seite
                ...
                for(Themengebiet t : themenliste ) {
                    ...
                    // werden die zugehörigen Artikel eingelesen
                    // dazu definieren wir eine JavaScript Funktion
                    // der die themengebietid als Argument übergeben wird.
                ...
                if (themenliste.size() > 0) {
                    ...
                    // (um später von diesem die Artikel anzuzeigen).
        ...
        <!-- rechts daneben ein wenig Platz für den Artikel
             und die Kommentare  -->
        <div class='right'>
            <div id='Artikel'>
...
<script>
    // eine Varaible für die Artikelliste
    ...
    // soll die Funktion "loaded" ausgeführt werden
    ...
    function ArtikelVonThemaAnzeigen(themenid) {
        ...
        xhttp.onreadystatechange = function() {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                // In JavaScript übernimmt dies die Klasse JSON
                ...
                // Client und können immer darauf zugreifen
                artikelListe = arr;
                // Der nächste Aufruf soll das JavaScriptArray Artikelliste
                ...
                // => dies ist eine weitere Technik, die öfters eingesetzt wird.
                if (arr.length > 0) {
                    ArtikelAnzeigen(0);

                }
            }
        };  //  Ende der Zuweisung der Funktionsdefinition für onreadystatechange

        // Nun bereiten wir das "Absenden" vor:
        // Die Argumente werden via POST übergeben
        ...
        // Die nächste Zeile ist immer dieselbe
